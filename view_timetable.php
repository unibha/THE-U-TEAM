            ...
            <?php else: ?>
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    <?php foreach ($schedule as $s): ?>
                        <div style="background: #fff; padding: 30px; border-radius: 28px; box-shadow: 0 4px 20px rgba(0,0,0,0.02); border: 1px solid #f1f5f9; display: grid; grid-template-columns: 180px 1fr 150px; gap: 30px; align-items: center;">
                            <div>
