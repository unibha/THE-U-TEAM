...
if (empty($email)) {
    header("Location: " . ROOT_URL . "/public/auth/reset_password.php");
    exit();
}
    ...
    <div class="page">
        <div class="registration-card">
            ...
            <?php if ($user && strtotime($user['reset_expires_at']) > time()): ?>
                <form id="updatePasswordForm" class="form-body" action="<?php echo ROOT_URL; ?>/public/auth/update_password.php" method="POST">
                    ...
                    <?php else: ?>
                        ...
                        <div class="form-actions">
                            ...
                            <p class="login-link"><a href="<?php echo ROOT_URL; ?>/public/auth/login.php">Back to Login</a></p>
                        </div>
                    <?php endif; ?>
                </form>
            <?php else: ?>
                 <div class="form-body">
                    ...
                    <div class="form-actions">
                        <p class="login-link">The link may have expired. <a href="<?php echo ROOT_URL; ?>/public/auth/reset_password.php">Request a new link</a></p>
                    </div>
                 </div>
            <?php endif; ?>
