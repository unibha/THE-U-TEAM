...
if (!isset($_SESSION['verifying_email'])) {
    header("Location: " . ROOT_URL . "/public/auth/signup.php");
    exit();
}
    ...
    if ($user) {
        if ($user['otp_code'] === $otp) {
            if (strtotime($user['otp_expires_at']) > time()) {
                ...
                header("Refresh: 2; url=" . ROOT_URL . "/public/auth/login.php");
            } else {
    ...
    <div class="page">
        <div class="registration-card">
            <div class="card-header">
                <div class="logo"><i class="fas fa-graduation-cap"></i> AMS</div>
                <h2>Verify Your Email</h2>
                <p>Enter the OTP sent to your email to activate your account.</p>
            </div>
            <form class="form-body" action="<?php echo ROOT_URL; ?>/public/auth/verify_otp.php" method="POST">
                ...
                ?>
                    ...
                    <div class="form-actions">
                        ...
                        <p class="login-link" style="text-align: center;">Didn't receive the email? <a href="<?php echo ROOT_URL; ?>/public/auth/verify_otp.php?resend" style="color: #6366f1; text-decoration: none; font-weight: 700;">Resend OTP</a></p>
                        <div style="text-align: center; margin-top: 15px;">
                            <a href="<?php echo ROOT_URL; ?>/public/auth/signup.php" style="color: #94a3b8; text-decoration: none; font-size: 0.9rem; font-weight: 600;">Back to Registration</a>
                        </div>
                    </div>
                <?php endif; ?>
            </form>
