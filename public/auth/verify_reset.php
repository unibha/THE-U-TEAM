    ...
    if ($user) {
        if ($user['reset_token'] === $otp) {
            if (strtotime($user['reset_expires_at']) > time()) {
                ...
                header("Refresh: 2; url=" . ROOT_URL . "/public/auth/update_password.php");
            } else {
    ...
    <div class="page">
        <div class="registration-card">
            ...
            <div class="form-body">
                ...
                <form action="<?php echo ROOT_URL; ?>/public/auth/verify_reset.php" method="POST">
                ...
                <?php if (empty($verify_success) || strpos($verify_success, 'Redirecting') === false): ?>
                    ...
                    <div class="form-actions">
                        ...
                        <p class="login-link">Didn't receive it? <a href="<?php echo ROOT_URL; ?>/public/auth/verify_reset.php?resend">Resend Code</a></p>
                        <p class="login-link"><a href="<?php echo ROOT_URL; ?>/public/auth/reset_password.php">Back to Email Input</a></p>
                    </div>
                <?php endif; ?>
            </form>
        </div>
