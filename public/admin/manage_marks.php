        ...
        <section class="admin-tools" style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-bottom: 50px;">
            <div>
                ...
                <div style="background: #fff; padding: 30px; border-radius: 25px; border: 1px solid #f1f5f9; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.02);">
                    <form action="<?php echo ROOT_URL; ?>/public/shared/view_marks.php" method="GET" style="display: flex; gap: 15px;">
                        ...
                        <button type="submit" style="background: var(--brand-gradient); color: #fff; border: none; padding: 14px 25px; border-radius: 14px; font-weight: 800; cursor: pointer;">View Profile</button>
                    </form>
                </div>
            </div>
            ...
            <div style="text-align: right; display: flex; flex-direction: column; justify-content: flex-end;">
                ...
                <div style="display: flex; gap: 10px; justify-content: flex-end;">
                    <a href="<?php echo ROOT_URL; ?>/public/admin/manage_exam.php" style="background: #f1f5f9; color: #475569; padding: 12px 20px; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 0.9rem;">Manage Exams</a>
                    <a href="<?php echo ROOT_URL; ?>/public/admin/manage_courses.php" style="background: #f1f5f9; color: #475569; padding: 12px 20px; border-radius: 12px; text-decoration: none; font-weight: 700; font-size: 0.9rem;">Manage Courses</a>
                </div>
            </div>
        </section>
                        ...
                        <div>
                            ...
                            <div style="margin-top: 15px; display: flex; gap: 15px;">
                                <div>
                                    ...
                                    <span style="font-size: 1.1rem; color: #1e293b; font-weight: 800;"><?php echo $s['avg_score'] !== null ? round($s['avg_score'], 1) : '0'; ?></span>
                                </div>
                                <div>
                                ...
                                <tr style="border-bottom: 1px solid #f1f5f9;">
                                    ...
                                    <td style="padding: 20px; text-align: center;">
                                        <div style="display: flex; justify-content: center; gap: 10px;">
                                            <a href="<?php echo ROOT_URL; ?>/public/teacher/manage_marks.php?exam_id=<?php echo $selected_exam; ?>" style="color: #3b82f6;"><i class="fas fa-edit"></i></a>
