        ...
        <section style="display: grid; grid-template-columns: 1fr 380px; gap: 40px;">
                                ...
                                <tr style="border-bottom: 1px solid #f1f5f9; transition: 0.2s ease;">
                                    ...
                                    <td style="padding: 20px; text-align: center;">
                                        <div style="display: flex; justify-content: center; gap: 15px;">
                                            <a href="edit_timetable.php?id=<?php echo $tt['id']; ?>" style="color: #3b82f6;"><i class="fas fa-edit"></i></a>
            ...
            <aside style="background: #fff; padding: 30px; border-radius: 30px; border: 1px solid #f1f5f9; box-shadow: 0 10px 40px rgba(0,0,0,0.03); height: fit-content; position: sticky; top: 40px;">
                ...
                <form action="" method="POST">
                    ...
                    <button type="submit" name="add_schedule" style="width: 100%; background: var(--brand-gradient); color: #fff; padding: 16px; border: none; border-radius: 14px; font-weight: 800; cursor: pointer; transition: 0.3s ease; box-shadow: 0 10px 15px -3px rgba(26, 54, 93, 0.3);">
                        Establish Session
                    </button>
                </form>
            </aside>
...
document.getElementById('timetableSearch').addEventListener('input', function(e) {
    ...
    fetch(`<?php echo ROOT_URL; ?>/public/api/search_timetable.php?q=${encodeURIComponent(query)}`)
        ...
        .then(data => {
            ...
            data.forEach(tt => {
                ...
                row.innerHTML = `
                    ...
                    <td style="padding: 20px; text-align: center;">
                        <div style="display: flex; justify-content: center; gap: 15px;">
                            <a href="<?php echo ROOT_URL; ?>/public/admin/edit_timetable.php?id=${tt.id}" style="color: #3b82f6;"><i class="fas fa-edit"></i></a>
