...
<div class="dashboard-container">
    ...
    <main class="main-content">
        <section style="display: grid; grid-template-columns: 1fr 350px; gap: 40px;">
            <!-- Courses List -->
            <div>
                <h2 style="font-size: 1.8rem; color: #1e293b; font-weight: 800; margin-bottom: 25px;">Available Courses</h2>
                            ...
                            <tr style="border-bottom: 1px solid #f1f5f9;">
                                ...
                                <td style="padding: 20px; text-align: center;">
                                    <div style="display: flex; justify-content: center; gap: 15px;">
                                        <a href="edit_course.php?id=<?php echo $course['id']; ?>" style="color: #6366f1; font-size: 1.1rem;"><i class="fas fa-edit"></i></a>
            ...
            <aside style="background: #f8fafc; padding: 30px; border-radius: 24px; border: 1px solid #f1f5f9; height: fit-content;">
                ...
                <form action="" method="POST">
                    <div style="margin-bottom: 20px;">
                        <label style="font-size: 0.85rem; font-weight: 700; color: #475569; margin-bottom: 8px; display: block;">Course Name</label>
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="font-size: 0.85rem; font-weight: 700; color: #475569; margin-bottom: 8px; display: block;">Course Code</label>
...
document.getElementById('courseSearch').addEventListener('input', function(e) {
    ...
    fetch(`<?php echo ROOT_URL; ?>/public/api/search_courses.php?q=${encodeURIComponent(query)}`)
        ...
        .then(data => {
            ...
            data.forEach(course => {
                ...
                row.innerHTML = `
                    ...
                    <td style="padding: 20px; text-align: center;">
                        <div style="display: flex; justify-content: center; gap: 15px;">
                            <a href="<?php echo ROOT_URL; ?>/public/admin/edit_course.php?id=${course.id}" style="color: #6366f1; font-size: 1.1rem;"><i class="fas fa-edit"></i></a>
