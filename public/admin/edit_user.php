...
try {
    ...
    if (!$user) {
        header("Location: " . ROOT_URL . "/public/admin/manage_users.php");
        exit();
    }
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($first_name) || empty($last_name) || empty($email)) {
        ...
        try {
            ...
            $pdo->commit();
            $message = "User updated successfully! <a href='" . ROOT_URL . "/public/admin/manage_users.php' style='color: #166534; font-weight: 700;'>Return to list</a>";
        ...
        <section class="form-container" style="max-width: 900px; margin: 0 auto; background: #fff; padding: 50px; border-radius: 24px; box-shadow: 0 10px 30px rgba(0,0,0,0.03);">
            ...
            <form action="" method="POST">
                ...
                <div style="text-align: center; margin-top: 50px;">
                    <button type="submit" style="background: var(--brand-gradient); color: #fff; padding: 18px 60px; border: none; border-radius: 15px; font-size: 1.1rem; font-weight: 800; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 10px 20px rgba(26, 54, 93, 0.2);">
