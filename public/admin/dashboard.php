    ...
    <div class="dashboard-body" style="display: flex; flex: 1;">
        ...
        <aside class="sidebar" style="z-index: 5; background: #fff;">
            <nav class="sidebar-nav">
                <ul id="sidebarMenu">
                    <li><a href="<?php echo ROOT_URL; ?>/public/shared/profile.php"><i class="fas fa-user-cog"></i> <span>Account</span></a></li>
                    <li class="active"><a href="<?php echo ROOT_URL; ?>/public/admin/dashboard.php"><i class="fas fa-th-large"></i> <span>Dashboard</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_users.php?role=Student"><i class="fas fa-user-graduate"></i> <span>Students</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_users.php?role=Teacher"><i class="fas fa-chalkboard-teacher"></i> <span>Teachers</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_courses.php"><i class="fas fa-book"></i> <span>Courses</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/assignment_audit.php"><i class="fas fa-file-alt"></i> <span>Assignment</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/attendance_master.php"><i class="fas fa-calendar-check"></i> <span>Attendance</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_enrollments.php"><i class="fas fa-link"></i> <span>Enroll Student</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/shared/manage_notice.php"><i class="fas fa-bullhorn"></i> <span>Notices</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_exam.php"><i class="fas fa-file-signature"></i> <span>Exams</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_marks.php"><i class="fas fa-chart-line"></i> <span>Student Marks</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_timetable.php"><i class="fas fa-calendar-alt"></i> <span>Timetable</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/admin/manage_resources.php"><i class="fas fa-folder-open"></i> <span>Resource Audit</span></a></li>
        ...
        <main class="main-content">
            ...
            <div class="attendance-report-container teacher-stats-grid">
                <div class="assignment-status-card" style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 30px;">
                    ...
                    <div style="font-size: 2.2rem; font-weight: 800; color: #1e293b;"><?php echo $totalStudents; ?></div>
                </div>

                <div class="assignment-status-card" style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 30px;">
                    <i class="fas fa-chalkboard-teacher" style="font-size: 2.2rem; color: #8b5cf6; margin-bottom: 12px;"></i>
                    <h3 style="margin-bottom: 5px; color: #64748b; font-size: 0.95rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Teachers</h3>
                    <div style="font-size: 2.2rem; font-weight: 800; color: #1e293b;"><?php echo $totalTeachers; ?></div>
                </div>

                <div class="assignment-status-card" style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 30px;">
                    <i class="fas fa-book" style="font-size: 2.2rem; color: #8b5cf6; margin-bottom: 12px;"></i>
                    <h3 style="margin-bottom: 5px; color: #64748b; font-size: 0.95rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Courses</h3>
                    <div style="font-size: 2.2rem; font-weight: 800; color: #1e293b;"><?php echo $totalCourses; ?></div>
                </div>
            </div>
...
document.getElementById('dashboardSearch').addEventListener('input', function(e) {
    ...
    // 3. Global Search for Users/Courses
    if (query.length > 1) {
        fetch(`<?php echo ROOT_URL; ?>/public/api/search_admin_dashboard.php?q=${encodeURIComponent(query)}`)
            .then(res => res.json())
            .then(data => {
                if ((data.users && data.users.length > 0) || (data.courses && data.courses.length > 0)) {
                    ...
                    if (data.users.length > 0) {
                        ...
                        data.users.forEach(u => {
                            html += `<a href="<?php echo ROOT_URL; ?>/public/admin/manage_users.php?search=${encodeURIComponent(u.first_name)}&role=${u.role}" style="display: block; padding: 10px; text-decoration: none; color: #1e293b; border-radius: 8px; transition: 0.2s;">
                    ...
                    if (data.courses.length > 0) {
                        ...
                        data.courses.forEach(c => {
                            html += `<a href="<?php echo ROOT_URL; ?>/public/admin/manage_courses.php?search=${encodeURIComponent(c.course_code)}" style="display: block; padding: 10px; text-decoration: none; color: #1e293b; border-radius: 8px; transition: 0.2s;">
