...
<div class="dashboard-container">
    <header class="dashboard-header">
        <div class="header-brand">
            ...
            <p>Admin Portal > Global Resource Audit</p>
        </div>
    ...
    <main class="main-content" style="padding: 40px 60px; background: #f8fafc;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            <h2 style="font-size: 1.8rem; color: #1e293b; font-weight: 800;">Master Resource Directory</h2>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s ease;">
                            ...
                            <td style="padding: 20px; text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 12px;">
                                    <a href="download_resource.php?id=<?php echo $r['resource_id']; ?>" target="_blank" style="padding: 8px 15px; background: #eff6ff; color: #3b82f6; border-radius: 10px; font-weight: 800; font-size: 0.75rem; text-decoration: none; border: 1px solid #dbeafe;">Review</a>
