...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_marks'])) {
    ...
    try {
        ...
        header("Location: " . ROOT_URL . "/public/teacher/manage_marks.php?exam_id=$selected_exam_id&msg=Success");
        exit();
    } catch (Exception $e) {
    ...
    <main class="main-content">
        ...
        <section style="margin-bottom: 40px;">
            <div style="background: #fff; padding: 25px; border-radius: 20px; border: 1px solid #f1f5f9; display: flex; align-items: center; justify-content: space-between;">
                ...
                <form action="<?php echo ROOT_URL; ?>/public/shared/view_marks.php" method="GET" style="display: flex; gap: 10px;">
            ...
            <section class="marks-entry-view">
                ...
                <form action="" method="POST">
                    ...
                    <div style="margin-top: 40px; display: flex; justify-content: flex-end; gap: 20px; align-items: center;">
                        ...
                        <button type="submit" name="save_marks" style="background: var(--brand-gradient); color: #fff; padding: 16px 45px; border: none; border-radius: 15px; font-weight: 800; cursor: pointer; transition: 0.3s ease; font-size: 1rem; box-shadow: 0 10px 15px -3px rgba(26, 54, 93, 0.3);">
