...
<div class="dashboard-container">
    <header class="dashboard-header">
        ...
        <div class="header-icons" style="margin-left: 20px; display: flex; gap: 15px; align-items: center;">
            <a href="<?php echo ROOT_URL; ?>/public/teacher/dashboard.php" style="color: #fff; text-decoration: none; font-weight: 700; font-size: 0.9rem; padding: 8px 16px; border: 1px solid rgba(255,255,255,0.3); border-radius: 12px;"><i class="fas fa-arrow-left" style="margin-right: 8px;"></i>Back</a>
        </div>
    </header>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9;">
                            ...
                            <td style="padding: 20px; text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 10px;">
                                    <a href="<?php echo ROOT_URL; ?>/public/shared/download_resource.php?id=<?php echo $s['submission_id']; ?>&type=submission" target="_blank" style="padding: 8px 15px; background: #eff6ff; color: #3b82f6; border-radius: 10px; font-weight: 800; font-size: 0.75rem; text-decoration: none;">View Work</a>
                                    <a href="grade_submission.php?sid=<?php echo $s['submission_id']; ?>" style="padding: 8px 15px; background: #fdf4ff; color: #a855f7; border-radius: 10px; font-weight: 800; font-size: 0.75rem; text-decoration: none;">Grade</a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
