...
<div class="dashboard-container">
    <header class="dashboard-header">
        ...
        <div class="header-icons" style="margin-left: 20px; display: flex; gap: 15px; align-items: center;">
            ...
            <a href="teacher_upload_resource.php" style="color: #fff; text-decoration: none; font-weight: 700; font-size: 0.9rem; padding: 8px 16px; border: 1px solid rgba(255,255,255,0.3); border-radius: 12px; background: #8b5cf6;"><i class="fas fa-plus" style="margin-right: 8px;"></i>Upload New</a>
        </div>
    </header>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s ease;">
                            ...
                            <td style="padding: 20px; text-align: center;">
                                <div style="display: flex; justify-content: center; gap: 12px;">
                                    <a href="download_resource.php?id=<?php echo $r['resource_id']; ?>" target="_blank" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: #f0fdf4; color: #10b981; border-radius: 10px; transition: 0.3s ease;" title="View"><i class="fas fa-eye"></i></a>
                                    <a href="teacher_edit_resource.php?id=<?php echo $r['resource_id']; ?>" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: #fef9c3; color: #ca8a04; border-radius: 10px; transition: 0.3s ease;" title="Edit"><i class="fas fa-edit"></i></a>
