    ...
    <div class="dashboard-body" style="display: flex; flex: 1;">
        ...
        <aside class="sidebar" style="z-index: 5; background: #fff;">
            <nav class="sidebar-nav">
                <ul id="sidebarMenu">
                    ...
                    <li><a href="<?php echo ROOT_URL; ?>/public/student/dashboard.php"><i class="fas fa-th-large"></i> <span>Dashboard</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/student/assignments.php"><i class="fas fa-file-alt"></i> <span>Assignment</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/shared/view_attendance.php"><i class="fas fa-calendar-check"></i> <span>Attendance</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/shared/view_exam.php"><i class="fas fa-file-signature"></i> <span>Exams</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/shared/view_marks.php"><i class="fas fa-graduation-cap"></i> <span>My Results</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/shared/view_timetable.php"><i class="fas fa-calendar-alt"></i> <span>Timetable</span></a></li>
                    <li><a href="<?php echo ROOT_URL; ?>/public/student/view_resources.php"><i class="fas fa-folder-open"></i> <span>Resources</span></a></li>
        ...
        <main class="main-content">
            ...
            <div class="attendance-report-container">
                ...
                <div class="assignment-status-card" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 25px;">
                    <i class="fas fa-clipboard-list" style="font-size: 2.2rem; color: #8b5cf6; margin-bottom: 12px;"></i>
                    <h3 style="margin-bottom: 15px; color: #1e293b; font-size: 1rem; font-weight: 700;">Assignment status</h3>
                    <ul style="list-style: none; text-align: left; padding-left: 0px; width: 100%;">
                ...
                <div class="assignment-status-card" style="background: #eff6ff; border-color: #dbeafe; display: flex; flex-direction: column; align-items: center; justify-content: space-between; padding: 25px;">
                    <div style="width: 100%;">
                    ...
                    <a href="<?php echo ROOT_URL; ?>/public/shared/view_notice.php" style="display: block; text-align: center; background: #3b82f6; color: #fff; padding: 12px; border-radius: 12px; text-decoration: none; font-weight: 800; font-size: 0.85rem; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.2); width: calc(100% - 24px);">View All Notices</a>
                </div>
            </div>
...
document.getElementById('dashboardSearch').addEventListener('input', function(e) {
    ...
    fetch(`<?php echo ROOT_URL; ?>/public/api/search_student_tasks.php?q=${encodeURIComponent(query)}`)
    ...
    if (query.length > 1) {
        ...
        fetch(`<?php echo ROOT_URL; ?>/public/api/search_student_dashboard.php?q=${encodeURIComponent(query)}`)
            .then(res => res.json())
            .then(data => {
                if ((data.courses && data.courses.length > 0) || (data.tasks && data.tasks.length > 0)) {
                    ...
                    if (data.courses.length > 0) {
                        ...
                        data.courses.forEach(c => {
                            html += `<a href="<?php echo ROOT_URL; ?>/public/student/assignments.php?course=${encodeURIComponent(c.course_code)}" style="display: block; padding: 10px; text-decoration: none; color: #1e293b; border-radius: 8px; transition: 0.2s;">
                    ...
                    if (data.tasks.length > 0) {
                        ...
                        data.tasks.forEach(t => {
                            html += `<a href="<?php echo ROOT_URL; ?>/public/student/assignments.php?search=${encodeURIComponent(t.title)}" style="display: block; padding: 10px; text-decoration: none; color: #1e293b; border-radius: 8px; transition: 0.2s;">
