            ...
            <?php else: ?>
                ...
                <div class="resource-card" style="background: #fff; border-radius: 28px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.02); border: 1px solid #f1f5f9; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 20px; border-top: 1px solid #f8fafc;">
                        ...
                        <a href="<?php echo ROOT_URL; ?>/public/shared/download_resource.php?id=<?php echo $res['resource_id']; ?>" style="color: #3b82f6; text-decoration: none; font-weight: 800; font-size: 0.85rem; display: flex; align-items: center; gap: 8px;">
...
document.getElementById('resourceSearch').addEventListener('input', function(e) {
    ...
    fetch(`<?php echo ROOT_URL; ?>/public/api/search_resources.php?q=${encodeURIComponent(query)}`)
            ...
            data.forEach(res => {
                ...
                card.innerHTML = `
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 20px; border-top: 1px solid #f8fafc;">
                        ...
                        <a href="<?php echo ROOT_URL; ?>/public/shared/download_resource.php?id=${res.resource_id}" style="color: #3b82f6; text-decoration: none; font-weight: 800; font-size: 0.85rem; display: flex; align-items: center; gap: 8px;">
                            <i class="fas fa-download"></i> Download
                        </a>
                    </div>
                `;
