                ...
                <div class="assignment-card" style="background: #fff; padding: 30px; border-radius: 28px; border: 1px solid #f1f5f9; box-shadow: 0 4px 20px rgba(0,0,0,0.02); display: flex; flex-direction: column;">
                    ...
                    <?php elseif (!$isExpired): ?>
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" style="width: 100%; background: #3b82f6; color: #fff; padding: 12px; border: none; border-radius: 12px; font-weight: 800; cursor: pointer;">Upload Submission</button>
                        </form>
                    <?php endif; ?>
                </div>
            <?php endforeach; ?>
...
document.getElementById('assignmentSearch').addEventListener('input', function(e) {
    ...
    fetch(`api_search_student_assignments.php?q=${encodeURIComponent(query)}`)
