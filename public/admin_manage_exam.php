        ...
        <section style="display: grid; grid-template-columns: 1fr 380px; gap: 40px;">
                                ...
                                <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s ease;">
                                    ...
                                    <td style="padding: 20px; text-align: center;">
                                        <div style="display: flex; justify-content: center; gap: 12px;">
                                            <a href="admin_edit_exam.php?id=<?php echo $exam['id']; ?>" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: #eff6ff; color: #3b82f6; border-radius: 10px; transition: 0.3s ease;"><i class="fas fa-edit"></i></a>
            ...
            <aside style="background: #f8fafc; padding: 35px; border-radius: 30px; border: 1px solid #f1f5f9; height: fit-content; position: sticky; top: 40px; box-shadow: 0 10px 30px rgba(0,0,0,0.02);">
                ...
                <form action="" method="POST">
                    ...
                    <button type="submit" name="add_exam" style="width: 100%; background: var(--brand-gradient); color: #fff; padding: 16px; border: none; border-radius: 14px; font-weight: 800; cursor: pointer; transition: all 0.3s ease; font-size: 1rem; box-shadow: 0 10px 15px -3px rgba(139, 92, 246, 0.3);">
        ...
        .then(data => {
            ...
            data.forEach(exam => {
                ...
                row.innerHTML = `
                    ...
                    <td style="padding: 20px; text-align: center;">
                        <div style="display: flex; justify-content: center; gap: 12px;">
                            <a href="admin_edit_exam.php?id=${exam.id}" style="width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; background: #eff6ff; color: #3b82f6; border-radius: 10px;"><i class="fas fa-edit"></i></a>
