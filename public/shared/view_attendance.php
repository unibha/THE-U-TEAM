...
<div class="dashboard-container">
    <header class="dashboard-header">
        ...
        <div class="header-icons" style="margin-left: 20px; display: flex; gap: 15px; align-items: center;">
            <a href="<?php echo ROOT_URL; ?>/public/student/dashboard.php" style="color: #fff; text-decoration: none; font-weight: 700; font-size: 0.9rem; padding: 8px 16px; border: 1px solid rgba(255,255,255,0.3); border-radius: 12px;">Dashboard</a>
        </div>
    </header>
    ...
    <main class="main-content">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 25px; margin-bottom: 50px;">
            <?php foreach ($courseStats as $course): ?>
                <?php 
                $percentage = ($course['total_days'] > 0) ? round(((($course['present_days'] ?? 0) / $course['total_days']) * 100), 2) : 0;
