...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_assignment'])) {
    ...
    if (empty($course_id) || empty($title)) {
        ...
        try {
            ...
            $message = "New assignment published! <a href='<?php echo ROOT_URL; ?>/public/shared/manage_assignment.php?course_id=$course_id' style='color: #166534; font-weight: 700;'>Reload View</a>";
        } catch (PDOException $e) {
...
<div class="dashboard-container">
    <header class="dashboard-header">
        ...
        <div class="header-icons" style="margin-left: 20px; display: flex; gap: 15px; align-items: center;">
            <a href="<?php echo $role == 'Admin' ? ROOT_URL . '/public/admin/dashboard.php' : ROOT_URL . '/public/teacher/dashboard.php'; ?>" style="color: #fff; text-decoration: none; font-weight: 700; font-size: 0.9rem; padding: 8px 16px; border: 1px solid rgba(255,255,255,0.3); border-radius: 12px;">Dashboard</a>
        </div>
    </header>
