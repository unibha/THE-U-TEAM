...
<div class="dashboard-container" style="flex-direction: column;">
    ...
    <main class="main-content profile-main-content" style="padding: 40px 60px; background: #f8fafc; display: flex; align-items: center; justify-content: center;">
            ...
            <div class="profile-form-container">
                ...
                <form action="" method="POST">
                    ...
                    <div style="display: flex; gap: 20px; align-items: center;">
                        ...
                        <a href="<?php echo ROOT_URL; ?>/public/auth/update_password.php" style="color: #6366f1; text-decoration: none; font-weight: 700; font-size: 0.9rem;">Change Password?</a>
                    </div>
                </form>
            </div>
        </div>
