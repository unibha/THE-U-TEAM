    ...
    <header class="dashboard-header">
        ...
        <div class="header-tools">
            ...
            <div class="header-icons" style="margin-left: 20px; display: flex; gap: 15px; align-items: center;">
                ...
                <a href="teacher_create_assignment.php" style="color: #fff; text-decoration: none; font-weight: 700; font-size: 0.9rem; padding: 8px 16px; border: 1px solid rgba(255,255,255,0.3); border-radius: 12px; background: #f97316;"><i class="fas fa-plus" style="margin-right: 8px;"></i>Create New</a>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9;">
                            ...
                            <td style="padding: 20px; text-align: center;">
                                <a href="teacher_view_submissions.php?assignment_id=<?php echo $a['assignment_id']; ?>" style="padding: 8px 15px; background: #eff6ff; color: #3b82f6; border-radius: 10px; font-weight: 800; font-size: 0.75rem; text-decoration: none;">View Submissions</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
...
document.getElementById('assignmentSearch').addEventListener('input', function(e) {
    ...
    fetch(`api_search_assignments.php?q=${encodeURIComponent(query)}`)
        ...
        .then(data => {
            ...
            data.forEach(a => {
                ...
                row.innerHTML = `
                    ...
                    <td style="padding: 20px; text-align: center;">
                        <a href="teacher_view_submissions.php?assignment_id=${a.assignment_id}" style="padding: 8px 15px; background: #eff6ff; color: #3b82f6; border-radius: 10px; font-weight: 800; font-size: 0.75rem; text-decoration: none;">View Submissions</a>
                    </td>
                `;
