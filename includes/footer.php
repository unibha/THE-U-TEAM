...
?>
<?php if (!isset($hideChatbot) || !$hideChatbot): ?>
    <!-- Floating Chatbot UI -->
    ...
    <script>
        ...
        async function sendMessage(text) {
            ...
            try {
                const response = await fetch('<?php echo ROOT_URL; ?>/public/auth/chatbot_api.php', {
                    method: 'POST',
...
<?php endif; ?>
    ...
    <script src="<?php echo ROOT_URL; ?>/assets/script.js?v=<?php echo time(); ?>"></script>
</body>
</html>
