...
function getChatbotData() {
    return [
        ...
        'navigation' => [
            'timetable' => ['text' => 'View Timetable', 'url' => ROOT_URL . '/public/shared/view_timetable.php'],
            'results' => ['text' => 'View Results', 'url' => ROOT_URL . '/public/shared/view_marks.php'],
            'marks' => ['text' => 'Check Marks', 'url' => ROOT_URL . '/public/shared/view_marks.php'],
            'assignment' => ['text' => 'Assignment Hub', 'url' => ROOT_URL . '/public/student/assignments.php'],
            'notice' => ['text' => 'Read Notices', 'url' => ROOT_URL . '/public/shared/view_notice.php'],
            'profile' => ['text' => 'Manage Profile', 'url' => ROOT_URL . '/public/shared/profile.php'],
            'password' => ['text' => 'Security Settings', 'url' => ROOT_URL . '/public/shared/profile.php'],
            'logout' => ['text' => 'Exit System', 'url' => ROOT_URL . '/public/auth/logout.php']
        ]
    ];
}
?>
